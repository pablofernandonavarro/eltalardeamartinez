<div>
    <div class="mb-6">
        <flux:heading size="xl">Asignar Usuario a Unidad Funcional</flux:heading>
    </div>
    ...
    <form wire:submit="save" class="space-y-6">
        <flux:field>
                ...
                @foreach($users as $user)
                    <option value="{{ $user->id }}">
                        ...
                        @if($user->role)
                            - {{ $user->role->label() }}
                        @else
                            - <span class="text-red-500">Sin rol (requiere asignación)</span>
                        @endif
                    </option>
                @endforeach
            </flux:select>
            ...
            <flux:description>
                Solo usuarios con rol "Propietario" pueden ser marcados como propietarios. 
                Los usuarios sin rol deben tener su rol asignado primero en la gestión de usuarios.
            </flux:description>
        </flux:field>
        ...
        <flux:field>
            ...
            <flux:description>Deje vacío si la relación está activa</flux:description>
        </flux:field>
